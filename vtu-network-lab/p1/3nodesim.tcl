...
#create TCPSink agent and attach to node n2
...
$ns set interval_ 0.0003
$ns set packetsize_ 500

#create a null agent to receive the CBR packet and attach to node n2
